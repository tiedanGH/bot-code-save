...
class ThreadKiller(threading.Thread):
    ...
    def __init__(self, target_thread, exception_cls, repeat_sec=1.0):
...
class TerminableThread(threading.Thread):
    ...
    def terminate(self, exception_cls, repeat_sec=1.0):
...
def timeout(sec, raise_sec=1):
    ...
    def decorator(func):
        ...
        def wrapped_func(*args, **kwargs):
            err_msg = f'Function timed out after {sec} second'
